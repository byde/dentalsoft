...
$(function(){
    $( "#dia_consultar" ).dialog({
        ...
        $(".btn_cancelar").live('click', function(e){
            e.preventDefault();
    ...
    $(".btn_consu").live("click",function(e){
        ...
        $(".btn_cuestionario").click(function(e){
            e.preventDefault();
...
<table border="0" cellpadding="1" cellspacing="1">
    ...
    <tr class="zebra">
        <td><?php echo $c['fechacita']; ?> 
            <?php if ($c['idestado'] == 2): ?><a href="index.php/caja/cobrar/<?php echo $c['idagenda'] ?>" class="button small green btn_cobrar">Cobrar</a><?php endif; ?>
            <?php if ($c['idestado'] == 1): ?><a href="index.php/consulta/consultar/<?php echo $c['idagenda'] ?>" class="button small green btn_consu">Consultar</a><?php endif; ?>
            <?php if ($c['idestado'] == 0): ?>
